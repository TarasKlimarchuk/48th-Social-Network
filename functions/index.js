...
const { login,signup, logout, addUserDetails, updateUserPhoto, getAuthenticatedUser, getUserDetails, markNotificationsRead} = require('./handlers/users')
...
app.post('/userPhoto', updateUserPhoto)
